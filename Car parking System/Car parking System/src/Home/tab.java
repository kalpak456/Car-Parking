...
private final ButtonGroup buttonGroup_2 = new ButtonGroup();
	...
	public tab() {
		...
		radioButton.setBounds(467, 255, 101, 23);
		...
		radioButton_1.setBounds(577, 255, 89, 23);
		...
		btnSubmit.addActionListener(new ActionListener() {
			private AbstractButton textField_3;

			public void actionPerformed(ActionEvent arg0) {
				information obj=new information();
				obj.insert(textField.getText(),textField_1.getText(),textField_2.getText(),textField_3.getText(),textField_4.getText(),c);
			}
		});
		panel_3.add(btnSubmit);
		
		JLabel lblCostumerNo = new JLabel("Car ID#");
		lblCostumerNo.setBounds(139, 80, 246, 14);
		lblCostumerNo.setFont(new Font("Tahoma", Font.BOLD, 15));
		panel_3.add(lblCostumerNo);
		
		JLabel lblCarNo = new JLabel("Token No#");
		lblCarNo.setBounds(139, 111, 232, 14);
		lblCarNo.setFont(new Font("Tahoma", Font.BOLD, 15));
		panel_3.add(lblCarNo);
		
		JLabel lblDate = new JLabel("Date");
		lblDate.setBounds(139, 142, 232, 14);
		...
		dateChooser.setBounds(467, 307, 199, 22);
